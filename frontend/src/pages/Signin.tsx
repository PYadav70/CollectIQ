...
export const Signin = () => {
    const usernameRef = useRef<HTMLInputElement>(null as unknown as HTMLInputElement)
    const passwordRef = useRef<HTMLInputElement>(null as unknown as HTMLInputElement)
